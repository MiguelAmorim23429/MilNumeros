...
const Header: React.FC<HeaderProps> = ({ setShowModal }) => {
  ...
  return (
    <header className="bg-[#00172E] text-white sticky top-0 z-50 shadow-md">
      ...
      {/* Mobile Nav */}
      {menuOpen && (
        <div className="md:hidden px-6 pb-4 space-y-4 font-medium bg-[#00172E]">
          ...
          <button
            onClick={() => setShowModal(true)}
            className="block w-full text-center bg-orange-500 text-white px-4 py-2 rounded-md hover:bg-orange-600 transition"
          >
            Pedir Orçamento
          </button>
        </div>
